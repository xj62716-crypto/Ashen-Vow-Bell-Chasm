...
@export_range(20.0, 64.0, 0.5) var grapple_pull_speed: float = 52.0
...
@export_range(8.0, 32.0, 0.5) var grapple_exit_speed: float = 26.0
@export_range(0.0, 8.0, 0.5) var grapple_exit_lift: float = 3.5
@export_range(0.1, 1.5, 0.05) var grapple_exit_momentum_seconds: float = 0.35
