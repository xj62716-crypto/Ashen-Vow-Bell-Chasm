...
@export_range(20.0, 40.0, 0.5) var grapple_pull_speed: float = 30.0
@export_range(60.0, 180.0, 5.0) var grapple_pull_acceleration: float = 110.0
...
@export_range(20.0, 40.0, 0.5) var grapple_max_speed: float = 32.0
@export_range(8.0, 24.0, 0.5) var grapple_exit_speed: float = 18.0
@export_range(0.0, 8.0, 0.5) var grapple_exit_lift: float = 3.5
@export_range(0.1, 1.5, 0.05) var grapple_exit_momentum_seconds: float = 0.75
