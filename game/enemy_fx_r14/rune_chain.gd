...
func _ready() -> void:
	...
	material=StandardMaterial3D.new();material.albedo_color=Color("a99b76");material.metallic=.76;material.roughness=.4;material.emission_enabled=true;material.emission=Color("8d754b");material.emission_energy_multiplier=.14;chain.material_override=material
	material.albedo_color=Color("807354");material.emission=Color("87a591")
...
func update_endpoints(start:Vector3,finish:Vector3,state:Dictionary) -> void:
	...
	material.emission_energy_multiplier=.2 if phase=="launch" else .42
